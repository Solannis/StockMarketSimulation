...
public class StockData {
	 ...
	 * private float stockSessionClose;			// The stock value at close of a given trading session.
	 ...
	 * private float stockYearLow;				// The lowest stock value during the current 52-week period.
	...
	/*
	 * Holdings used in Tutorial Mode (COMMODITIES, total of 18 holdings)
	 * 
	...
	public static final String[] TUTORIAL_BASIC_STOCK_SYMBOLS = {
